...
hidden if the `xoshiro256starstar_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `xoshiro256starstar_DEVELOPER_MODE` to the configure
...
the operating system you have, which may be `win64`, `unix` or `darwin`. You
